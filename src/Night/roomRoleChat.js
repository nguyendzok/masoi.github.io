...
module.exports = async function (gamef, bot, userRoom) {
    ...
    gameIsNotEnd ? await asyncForEach(gamef.getRoom(userRoom).players, (p) => {
        if (p && gamef.getRoom(userRoom).alivePlayer[p.joinID]) {
            ...
            if (p.role == -1) {//SÓI
                return sendImageCard(bot, p.joinID, 'https://www.facebook.com/710823312597253/photos/pcb.719964681683116/719964505016467', 'Ma sói')
                    .then(() => {
                        bot.say(p.joinID, {
                ...
                return sendImageCard(bot, p.joinID, 'https://www.facebook.com/710823312597253/photos/pcb.719964681683116/719964545016463', 'Sói nguyền')
                    .then(() => {
                        bot.say(p.joinID, {
                ...
                return sendImageCard(bot, p.joinID, 'https://www.facebook.com/710823312597253/photos/pcb.719964681683116/719964631683121', 'Tiên tri')
                    .then(() => {
                        bot.say(p.joinID, {
                ...
                return sendImageCard(bot, p.joinID, 'https://www.facebook.com/710823312597253/photos/pcb.719964681683116/719964415016476', 'Bảo vệ')
                    .then(() => {
                        bot.say(p.joinID, {
                ...
                return sendImageCard(bot, p.joinID, 'https://www.facebook.com/710823312597253/photos/pcb.719964681683116/719964598349791', 'Thợ săn')
                    .then(() => {
                        bot.say(p.joinID, {
                ...
                return sendImageCard(bot, p.joinID, 'https://www.facebook.com/710823312597253/photos/pcb.719964681683116/719964395016478', 'Bán sói')
                    .then(() => {
                ...
                autoRoleDone ? gamef.getRoom(userRoom).roleDoneBy(p.joinID, false, true) : false;
                return sendImageCard(bot, p.joinID, 'https://www.facebook.com/710823312597253/photos/pcb.719964681683116/719964571683127', 'Phù thủy')
                    .then(() => {
                        bot.say(p.joinID, {
                            text: preTxt + sayTxt,
                            quickReplies: ["/evote"],
                ...
                autoRoleDone ? gamef.getRoom(userRoom).roleDoneBy(p.joinID, false, true) : false;
                return sendImageCard(bot, p.joinID, 'https://www.facebook.com/710823312597253/photos/pcb.719964681683116/719964478349803', 'Già làng')
                    .then(() => {
                        bot.say(p.joinID, preTxt + `👴Bạn là Già làng! Bảo trọng =))\n${playersListTxt}`);
                    });
            } else if (p.role == 7) { // THẦN TÌNH YÊU
                return sendImageCard(bot, p.joinID, 'https://www.facebook.com/710823312597253/photos/pcb.719964681683116/719964408349810', 'Thần tình yêu')
                    .then(() => {
                        bot.say(p.joinID, {
                ...
                autoRoleDone ? gamef.getRoom(userRoom).roleDoneBy(p.joinID, false, true) : false;
                return sendImageCard(bot, p.joinID, 'https://www.facebook.com/710823312597253/photos/pcb.719964681683116/719964528349798', 'Người hóa sói')
                    .then(() => {
                        bot.say(p.joinID, preTxt + `👽Yên tâm, bạn là DÂN tuy nhiên tiên tri thì không nghĩ vậy :v`);
                    });
            } else if (p.role == 9) { // THIÊN SỨ
                autoRoleDone ? gamef.getRoom(userRoom).roleDoneBy(p.joinID, false, true) : false;
                return sendImageCard(bot, p.joinID, 'https://www.facebook.com/710823312597253/photos/pcb.719964681683116/719964588349792', 'Thiên sứ')
                    .then(() => {
                        bot.say(p.joinID, preTxt + `🧚‍Bạn là THIÊN SỨ\nHãy chết ở ngày đầu tiên để dành chiến thắng!`);
                    });
            } else { // DÂN
                autoRoleDone ? gamef.getRoom(userRoom).roleDoneBy(p.joinID, false, true) : false;
                return sendImageCard(bot, p.joinID, 'https://www.facebook.com/710823312597253/photos/pcb.719964681683116/719964445016473', 'Dân thường')
                    .then(() => {
                        bot.say(p.joinID, preTxt + `🎅Bạn là thường dân! Ngủ tiếp đi :))\n${playersListTxt}`);
                    });
            }
        } else {
            return sendImageCard(bot, p.joinID, 'https://www.facebook.com/710823312597253/photos/pcb.719964681683116/719964485016469', 'Bạn đã chết')
                .then(() => {
