            ...
            convo.ask(`Chú ý userID đếm bắt đầu từ 0, Số Thứ Tự trong phòng bắt đầu từ 1! (userID + 1 = STT)\nCác lệnh cơ bản:\nĐể reset 2 phòng: /resetAll\nĐể kick người chơi: /kick <userRoom> <userID>\nHủy: /cancel`, (payload, convo) => {
                if (!payload.message) {
                    ...
                    if (chatTxt.match(/\/resetAll/g)) {
                        gamef.resetAllRoom();
                        chat.say('Đã khởi tạo lại toàn bộ Server!\nĐã tạo lại các phòng chơi và xóa các người chơi!');
